...
`;function Af(e){let t=_e(e.environmentId,{_tag:`workspace-file`,threadId:e.threadRef.threadId,path:e.absolutePath}),[n,r]=(0,P.useState)(null);return t._tag===`Failure`||t._tag===`Success`&&n===t.url?(0,F.jsx)(`div`,{className:`flex min-h-0 flex-1 items-center justify-center px-6 text-center text-xs leading-relaxed text-destructive`,children:`Unable to load workspace image.`}):t._tag===`Success`?(0,F.jsx)(`div`,{className:`flex min-h-0 flex-1 items-center justify-center overflow-auto p-4`,children:(0,F.jsx)(`img`,{className:`max-h-full max-w-full object-contain`,src:t.url,alt:e.alt,onError:()=>r(t.url)})}):(0,F.jsx)(`div`,{className:`flex min-h-0 flex-1 items-center justify-center text-muted-foreground`,children:(0,F.jsx)(ie,{className:`size-5 animate-spin`})})}function jf(e,t){let n=1;for(let t=0;t<e.length;t+=1){let r=e.charCodeAt(t);r===10?n+=1:r===13&&(n+=1,e.charCodeAt(t+1)===10&&(t+=1))}return Math.min(Math.max(1,t),n)}function Mf(e,t){let n=e.shadowRoot??e;for(let e of n.querySelectorAll(`[${Of}]`))e.removeAttribute(Of);t!==null&&(n.querySelector(`[data-line="${t}"]`)?.setAttribute(Of,``),n.querySelector(`[data-column-number="${t}"]`)?.setAttribute(Of,``))}function Nf(e,t,n){let[r]=(0,P.useState)(()=>new Map),[i]=(0,P.useState)(()=>new Map),[a]=(0,P.useState)(()=>new Map);return(0,P.useCallback)((o,s,c)=>{if(e===null)return;let l=()=>{let t=a.get(e);t!==void 0&&(cancelAnimationFrame(t),a.delete(e))};if(c===`unmount`){l();return}let u=t===null?null:jf(s.file?.contents??``,t);if(Mf(o,u),!(s instanceof Qe))return;if(i.get(e)!==n&&(l(),i.set(e,n)),u===null){o.style.minHeight=``;return}let d=o.closest(`.file-preview-virtualizer`);!d||(o.style.minHeight=`${Math.ceil(Math.max(s.height,d.clientHeight))}px`,r.get(e)===n||a.has(e))||a.set(e,requestAnimationFrame(()=>{if(a.delete(e),i.get(e)!==n||!o.isConnected)return;let t=s.getLinePosition(u);if(!t)return;let c=d.scrollTop+o.getBoundingClientRect().top-d.getBoundingClientRect().top,l=Math.max(0,c+t.top-Math.max(0,(d.clientHeight-t.height)/2)),f=Math.max(0,d.scrollHeight-d.clientHeight);d.scrollTop=Math.min(l,f),r.set(e,n)}))},[r,i,a,e,t,n])}function Pf({environmentId:e,cwd:t,relativePath:n,onPendingChange:r}){let i=_(Me.writeFile),a=(0,P.useMemo)(()=>new Tf({debounceMs:Df,onPendingChange:e=>r(n,e),persist:r=>i({environmentId:e,input:{cwd:t,relativePath:n,contents:r}}),onConfirmed:r=>{uf(e,t,n,r)}}),[t,e,r,n,i]);return(0,P.useEffect)(()=>()=>a.dispose(),[a]),a}function Ff({environmentId:e,cwd:t,relativePath:n,composerDraftTarget:r,contents:i,resolvedTheme:a,revealRequestId:o,wordWrap:s,onPostRender:c,onPendingChange:u}){let d=l(e=>e.addReviewComment),f=l(e=>e.removeReviewComment),[p,m]=(0,P.useState)([]),[h,g]=(0,P.useState)(null),_=h?.revealRequestId===o?h.range:null,v=(0,P.useCallback)(e=>{g({revealRequestId:o,range:e})},[o]),y=(0,P.useRef)(null),x=(0,P.useRef)(null),S=Pf({environmentId:e,cwd:t,relativePath:n,onPendingChange:u}),C=(0,P.useMemo)(()=>new mr({onChange:(i,a)=>{if(cf(e,t,n,i.contents),S.change(i.contents),a){let e=Je(a);m(e);for(let t of e)for(let e of t.metadata.entries)e.kind===`comment`&&d(r,b({id:e.id,filePath:n,startLine:e.startLine,endLine:e.endLine,text:e.text,contents:i.contents}))}}}),[d,r,t,e,n,S]);(0,P.useEffect)(()=>()=>{C.cleanUp()},[C]);let w=(0,P.useCallback)(e=>{v(null),f(r,e),m(t=>t.flatMap(t=>{let n=t.metadata.entries.filter(t=>t.id!==e);return n.length>0?[{...t,metadata:{entries:n}}]:[]}))},[r,f,v]),ee=(0,P.useCallback)((e,t)=>{v(null);let a=p.flatMap(e=>e.metadata.entries).find(t=>t.id===e);a&&d(r,b({id:a.id,filePath:n,startLine:a.startLine,endLine:a.endLine,text:t,contents:i})),m(n=>n.map(n=>({...n,metadata:{entries:n.metadata.entries.map(n=>n.id===e?{...n,kind:`comment`,text:t}:n)}})))},[d,r,i,p,n,v]),T=(0,P.useCallback)(e=>{let{startLine:t,endLine:n}=Ze(e),r={id:Ye(),kind:`draft`,startLine:t,endLine:n,text:``};m(e=>{let t=e.flatMap(e=>{let t=e.metadata.entries.filter(e=>e.kind!==`draft`);return t.length>0?[{...e,metadata:{entries:t}}]:[]}),i=t.findIndex(e=>e.lineNumber===n);return i<0?[...t,{lineNumber:n,metadata:{entries:[r]}}]:t.map((e,t)=>t===i?{...e,metadata:{entries:[...e.metadata.entries,r]}}:e)})},[]),E=p.some(e=>e.metadata.entries.some(e=>e.kind===`draft`));(0,P.useEffect)(()=>{let e=y.current;if(e)return yf({root:e,editor:C,isBlocked:()=>E,onDismiss:()=>v(null)})},[C,E,v]);let te=(0,P.useCallback)(e=>{v(e),e&&T(e)},[T,v]),ne=(0,P.useCallback)((e,t,n)=>{c(e,t,n),x.current!==null&&(cancelAnimationFrame(x.current),x.current=null),n!==`unmount`&&(x.current=requestAnimationFrame(()=>{x.current=null,e.isConnected&&t.setSelectedLines(_,{notify:!1})}))},[c,_]);return(0,F.jsx)(De,{editor:C,children:(0,F.jsx)(`div`,{ref:y,className:`flex min-h-0 flex-1`,children:(0,F.jsx)(ye,{className:`file-preview-virtualizer min-h-0 flex-1 overflow-auto`,config:{overscrollSize:600,intersectionObserverMargin:1200},children:(0,F.jsx)(it,{file:{name:n,contents:i,cacheKey:xf(t,n,i)},options:{disableFileHeader:!0,enableGutterUtility:!E,enableLineSelection:!E,onGutterUtilityClick:v,onLineSelectionChange:v,onLineSelectionEnd:te,overflow:s?`wrap`:`scroll`,theme:N(a),themeType:a,unsafeCSS:kf,onPostRender:ne},selectedLines:_,lineAnnotations:p,renderAnnotation:e=>(0,F.jsx)(`div`,{className:`py-1`,children:e.metadata.entries.map(e=>(0,F.jsx)(Ke,{kind:e.kind,rangeLabel:$e(e.startLine,e.endLine),text:e.text,onCancel:()=>w(e.id),onComment:t=>ee(e.id,t),onDelete:()=>w(e.id)},e.id))}),className:`min-h-full`,contentEditable:!0})})})})}function If({environmentId:e,cwd:t,relativePath:n,contents:r,threadRef:i,onPendingChange:a}){let o=Pf({environmentId:e,cwd:t,relativePath:n,onPendingChange:a});return(0,F.jsx)(We,{className:`min-h-0 flex-1`,children:(0,F.jsx)(de,{text:r,cwd:t,threadRef:i,className:`mx-auto max-w-4xl px-6 py-5`,onTaskListChange:({markerOffset:i,checked:a})=>{let s=lf(e,t,n)?.contents??r,c=wf(s,i,a);c!==s&&(cf(e,t,n,c),o.change(c))}})})}function Lf(){try{return v(Ef,re)??!0}catch(e){return console.error(e),!0}}function Rf({environmentId:a,cwd:s,projectName:c,relativePath:l,threadRef:u,composerDraftTarget:d,keybindings:f,availableEditors:p,revealLine:g,revealRequestId:v,onOpenFile:b,onPendingChange:x}){let{resolvedTheme:w}=n(),te=He(e=>e.wordWrap),ne=m(),D=y(a),O=r(xe.createUrl,{reportFailure:!1}),k=_(e.open,{reportFailure:!1}),ae=l!==null&&st(l),M=pf(a,s,l,!ae),[ce,ue]=(0,P.useState)(Lf),[de,fe]=(0,P.useState)({path:null,revealRequestId:null}),pe=(0,P.useRef)(null),me=l?Cf(l):!1,he=me&&de.path===l&&(g===null||de.revealRequestId===v),_e=l!==null&&t()&&be(l),ve=l?Ue(l,s):null,Se=(0,P.useMemo)(()=>l?Sf(c,l):[],[c,l]),Ce=Nf(l,g,v);(0,P.useEffect)(()=>{(pe.current?.querySelector(`[data-current-file-crumb='true']`))?.scrollIntoView({block:`nearest`,inline:`end`})},[l]);let we=()=>{ue(e=>{let t=!e;try{o(Ef,t,re)}catch(e){console.error(e)}return t})},Te=(0,P.useCallback)(()=>{!ve||!D||(async()=>{let e=await Ee({threadRef:u,filePath:ve,httpBaseUrl:D,createAssetUrl:O,openPreview:k});if(e._tag===`Success`||S(e))return;let t=C(e);j.add(A({type:`error`,title:`Unable to open file in browser`,description:t instanceof Error?t.message:`An error occurred.`}))})()},[ve,O,D,k,u]);return(0,F.jsxs)(`div`,{className:`flex min-h-0 flex-1 flex-col overflow-hidden bg-background`,children:[l?(0,F.jsxs)(`div`,{className:`surface-subheader gap-2 px-3`,"data-surface-subheader":!0,children:[(0,F.jsx)(We,{ref:pe,hideScrollbars:!0,scrollFade:!0,className:`min-w-0 flex-1 rounded-none`,"data-file-breadcrumbs":!0,children:(0,F.jsx)(`div`,{className:`flex h-full w-max min-w-full items-center text-xs`,children:Se.map((e,t)=>(0,F.jsxs)(`div`,{className:`flex min-w-0 shrink-0 items-center`,"data-current-file-crumb":e.kind===`file`,children:[t>0?(0,F.jsx)(h,{className:`mx-1 size-3.5 shrink-0 text-muted-foreground/60`}):null,(0,F.jsx)(`span`,{className:i(`max-w-40 truncate`,e.kind===`file`?`font-medium text-foreground`:`text-muted-foreground`),title:e.path||c,children:e.label})]},e.path||`project`))})}),ve&&a===ne?(0,F.jsx)(ge,{environmentId:a,keybindings:f,availableEditors:p,openInCwd:ve,compact:!0,enableShortcut:!1}):null,me?(0,F.jsxs)(E,{children:[(0,F.jsx)(ee,{render:(0,F.jsx)(Ve,{className:`shrink-0`,pressed:he,onPressedChange:e=>{fe({path:e?l:null,revealRequestId:e?v:null})},"aria-label":he?`Show markdown source`:`Show rendered markdown`,variant:`ghost`,size:`sm`,children:he?(0,F.jsx)(le,{className:`size-3.5`}):(0,F.jsx)(se,{className:`size-3.5`})})}),(0,F.jsx)(T,{children:he?`Show markdown source`:`Show rendered markdown`})]}):null,_e?(0,F.jsxs)(E,{children:[(0,F.jsx)(ee,{render:(0,F.jsx)(Ve,{className:`shrink-0`,pressed:!1,onPressedChange:Te,"aria-label":`Open file in preview browser`,variant:`ghost`,size:`sm`,children:(0,F.jsx)(oe,{className:`size-3.5`})})}),(0,F.jsx)(T,{children:`Open file in preview browser`})]}):null,(0,F.jsxs)(E,{children:[(0,F.jsx)(ee,{render:(0,F.jsx)(Ve,{className:`shrink-0`,pressed:ce,onPressedChange:we,"aria-label":ce?`Hide file explorer`:`Show file explorer`,variant:`ghost`,size:`sm`,children:(0,F.jsx)(et,{className:`size-3.5`})})}),(0,F.jsx)(T,{children:ce?`Hide file explorer`:`Show file explorer`})]})]}):null,l&&M.data?.truncated?(0,F.jsxs)(`div`,{className:`shrink-0 border-b border-amber-500/20 bg-amber-500/8 px-3 py-1.5 text-[11px] text-amber-700 dark:text-amber-300`,children:[`Preview limited to the first 1 MB of a `,M.data.byteLength.toLocaleString(),` byte file.`]}):null,(0,F.jsxs)(`div`,{className:`flex min-h-0 flex-1 overflow-hidden`,children:[(0,F.jsx)(`div`,{className:i(`min-w-0 flex-1 flex-col overflow-hidden`,l?`flex`:`hidden`),children:l&&ae&&ve?(0,F.jsx)(Af,{environmentId:a,threadRef:u,absolutePath:ve,alt:l},ve):l&&M.error&&M.data===null?(0,F.jsx)(`div`,{className:`flex min-h-0 flex-1 items-center justify-center px-6 text-center text-xs leading-relaxed text-destructive`,children:M.error}):l&&M.data===null?(0,F.jsx)(`div`,{className:`flex min-h-0 flex-1 items-center justify-center text-muted-foreground`,children:(0,F.jsx)(ie,{className:`size-5 animate-spin`})}):l&&M.data?me&&he?(0,F.jsx)(If,{environmentId:a,cwd:s,relativePath:l,threadRef:u,contents:M.data.contents,onPendingChange:x}):M.data.truncated?(0,F.jsx)(ye,{className:`file-preview-virtualizer min-h-0 flex-1 overflow-auto`,config:{overscrollSize:600,intersectionObserverMargin:1200},children:(0,F.jsx)(it,{file:{name:l,contents:M.data.contents,cacheKey:xf(s,l,M.data.contents)},options:{disableFileHeader:!0,overflow:te?`wrap`:`scroll`,theme:N(w),themeType:w,unsafeCSS:kf,onPostRender:Ce},className:`min-h-full`})},`${l}:${w}:${M.data.byteLength}`):(0,F.jsx)(Ff,{environmentId:a,cwd:s,relativePath:l,composerDraftTarget:d,contents:M.data.contents,resolvedTheme:w,revealRequestId:v,wordWrap:te,onPostRender:Ce,onPendingChange:x},`${l}:${w}`):null}),ce||l===null?(0,F.jsx)(`aside`,{className:i(`flex min-h-0 shrink-0 bg-background`,l?`w-[min(22rem,46%)] min-w-64 border-l border-border/60`:`min-w-0 flex-1`),children:(0,F.jsx)(gf,{environmentId:a,cwd:s,projectName:c,onOpenFile:b},`${a}:${s}`)}):null]})]})}export{Rf as default};