...
const awsSigner = await readFile(new URL("../sparky-analytics-admin/convex/awsReleases.ts", import.meta.url), "utf8");
const releaseBackend = await readFile(new URL("../sparky-analytics-admin/convex/releases.ts", import.meta.url), "utf8");
