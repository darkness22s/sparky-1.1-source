...
const seoPlugin = () => ({
  ...
  transformIndexHtml: {
    ...
    handler(html, ctx) {
      ...
      const noIndex = relativePath === "admin.html" || relativePath === "404.html";
      const tags = [
            ...
            return [
              {
                ...
                attrs: {
                  ...
                  content: env.VITE_SPARKY_ANALYTICS_ENDPOINT || "",
                },
                injectTo: "head",
              },
              {
              ...
              },
              {
                ...
                attrs: {
                  ...
                  content:
                    ...
                    "https://loyal-wildebeest-259.eu-west-1.convex.cloud",
                },
                injectTo: "head",
              },
              {
