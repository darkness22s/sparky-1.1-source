...
import { parsePersistedServerObservabilitySettings } from "@sparky/shared/serverSettings";
import { DesktopBackendBootstrap, PortSchema } from "@sparky/contracts";
...
export const baseDirFlag = Flag.string("base-dir").pipe(
  Flag.withDescription(
    "Explicit Sparky data directory; runtime state is stored under userdata (equivalent to T3CODE_HOME).",
  ),
  Flag.optional,
);
