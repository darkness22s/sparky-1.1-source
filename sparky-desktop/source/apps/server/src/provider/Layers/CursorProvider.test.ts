...
import type { CursorSettings } from "@sparky/contracts";
...
const cursorAcpDiscoveryFailedMessage = [
  ...
  "Cursor CLI setup may be incomplete; install or enable the Cursor CLI, restart Sparky, and try again.",
...
const cursorCliCommandMissingMessage = [
  ...
  `Install or enable the Cursor CLI, make sure \`${missingCursorBinaryPath}\` is on PATH, then restart Sparky.`,
  "See https://cursor.com/docs/cli/installation.",
].join(" ");
