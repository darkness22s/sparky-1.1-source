    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Sparky agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Sparky to connect to Sparky servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow Sparky to access your camera so you can scan pairing QR codes.",
