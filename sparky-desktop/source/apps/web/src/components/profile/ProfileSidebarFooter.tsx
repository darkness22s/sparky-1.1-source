    ...
    <SidebarFooter className="gap-1 p-2">
      <Menu>
        <MenuTrigger
          render={
            <SidebarMenuButton
              ...
              className="h-9 gap-2 rounded-lg px-2 text-left text-sm text-muted-foreground transition-[background-color,transform] duration-200 ease-out hover:scale-[1.01] hover:bg-accent hover:text-foreground active:scale-[0.98] data-popup-open:bg-accent motion-reduce:transform-none motion-reduce:transition-none"
            />
          }
        >
        ...
        <MenuPopup
          ...
          side="top"
          sideOffset={8}
          className="w-64 rounded-xl border-border/80 bg-card/20 shadow-xl backdrop-blur-xl dark:bg-card/45"
        >
