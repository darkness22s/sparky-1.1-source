import { RelayEnvironmentConnectScope } from "@sparky/contracts/relay";
import { withRelayClientTracing } from "@sparky/shared/relayTracing";
...
>()("@sparky/client-runtime/connection/resolver/ConnectionResolver") {}
