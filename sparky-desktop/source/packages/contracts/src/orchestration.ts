...
const ModelSelectionWire = Schema.Struct({
  ...
  /** Provenance for the selected context capability, when known. */
  contextWindowSource: Schema.optionalKey(Schema.Literals(["provider", "oauth", "models.dev"])),
});
...
const ModelSelectionSource = Schema.Struct({
  ...
  contextWindowSource: Schema.optional(Schema.Unknown),
});
  ...
  Schema.decodeTo(
    ...
    SchemaTransformation.transformOrFail({
      decode: (raw) => {
        ...
        if (raw.contextWindowSource !== undefined) {
          base.contextWindowSource = raw.contextWindowSource;
        }
      ...
      encode: (value) => {
        ...
        if (value.contextWindowSource !== undefined) {
          base.contextWindowSource = value.contextWindowSource;
        }
