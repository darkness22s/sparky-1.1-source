...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let Sparky spawn the server when needed.",
        providerSettingsForm: {
...
/** Personality presets that modify Sparky's system prompt tone and behavior. */
...
export const ServerSettings = Schema.Struct({
  ...
  sparkyPersonality: SparkyPersonality.pipe(
    Schema.withDecodingDefault(Effect.succeed("coding" as const)),
  ),
  // Keep the live assistant text visible while tools and plans are running.
  ...
  sparkyCloudUrl: TrimmedString.pipe(Schema.withDecodingDefault(Effect.succeed(""))),
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  sparkyCloudUrl: Schema.optionalKey(TrimmedString),
